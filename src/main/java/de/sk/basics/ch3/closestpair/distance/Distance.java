...
public interface Distance {
    ...
    /**
     * Calculates the distance between the given two points p1 and p2.
     *
    ...
    /**
     * Calculates the distance between the given pair of points.
     *
     * @param pair pair of points
     * @return distance between the given pair of points.
     */
