...
/**
 * Interface defining the methods for implementations of an integer splitter splitting integers into their halves based on the single digits, not the value.
 */
public interface IntegerSplitter {

    /**
     * Splits both given integers x and y uniformly into halves and returns the respective resulting pairs (x->a|b, y-> c|d).
     * For example, if
     ...
     * y = 5678 -> c = 56, d = 78
     * <br>
     * Integer n must be >= max{|digits x|, |digits y|}. It ensures a uniform split of x and y, i.e. the resulting split
     ...
     * @return integer x split into the pair (a|b) and integer y split into the pair (c|d), i.e. a pair of ( (a|b) | (c|d) )
     *
     */
